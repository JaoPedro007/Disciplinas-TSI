...
public class ConsultaController {
	...
	public String cadastrar(@ModelAttribute("e") Consulta consulta, @RequestParam("paciente.id") Long pacienteId,
			@RequestParam("medico.id") Long medicoId, Model model) {
		if (consultaService.temConsultaAgendada(pacienteId)) {
			model.addAttribute("error", "Não foi possível cadastrar a consulta. Paciente já tem consulta AGENDADA");
			return "cadastrarConsulta";
		}
